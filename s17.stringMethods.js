...
var newStory = story.replace(/cheeseburgers/g, "hamburgers")
var secondStory = newStory.replace(/Cheeseburgers/g, "Hamburgers")
var thirdStory = secondStory.replace(/cheeseburger/g, "hamburger")
var finalStory = thirdStory.replace(/bun/gi, "BUN")
